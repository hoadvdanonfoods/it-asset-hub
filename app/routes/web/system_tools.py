...
def backup_list(request: Request, current_user=None):
    return templates.TemplateResponse('system/backups.html', {'request': request, 'current_user': current_user, 'backups': _list_backups(), 'db_path': str(_db_path())})
...
def restore_page(request: Request, current_user=None):
    return templates.TemplateResponse('system/restore.html', {'request': request, 'current_user': current_user, 'backups': _list_backups(), 'error': None})
