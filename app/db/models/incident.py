...
class Incident(Base):
    ...
    category_id: Mapped[int | None] = mapped_column(ForeignKey('incident_categories.id'), nullable=True, index=True)
    priority_id: Mapped[int | None] = mapped_column(ForeignKey('priorities.id'), nullable=True, index=True)
